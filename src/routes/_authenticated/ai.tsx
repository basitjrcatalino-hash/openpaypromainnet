      ...
      >
        <div className="flex items-end gap-2 rounded-3xl border border-border/70 bg-card/70 p-2 pl-4 backdrop-blur">
          <textarea
            ...
            placeholder="Message…"
            className="max-h-32 flex-1 min-h-9 resize-none bg-transparent py-1.5 text-sm outline-none placeholder:text-muted-foreground"
          />
          <button
            type="submit"
      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: ({ className, children }) => {
            ...
            return (
              <code className="block wrap-break-word whitespace-pre-wrap font-mono text-[13px] leading-relaxed">
                {children}
              </code>
            );
          },
