  ...
  -d '{
    ...
    "from_username": "bob"
          ...
          <p>
            ...
            Product deep-link:{" "}
            <Link to="/topup" search={{ openpay_charge: undefined, openpay_ref: undefined, openpay_tx: undefined, openpay_return: undefined, openpay_cancel: undefined, banxa_return: undefined, banxa_ext: undefined }} className="font-semibold text-foreground underline-offset-2 hover:underline">
              /topup
            </Link>
            .
          </p>
