    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/docs/pro-pay", changefreq: "monthly", priority: "0.85" },
          { path: "/docs/integrations", changefreq: "monthly", priority: "0.85" },
          { path: "/partner-api", changefreq: "weekly", priority: "0.8" },
