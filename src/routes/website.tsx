...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Pro Pay · Merchant", href: "/docs/pro-pay", desc: "Checkout, receive wallet, earnings" },
      { label: "Pro Connect · Auth & Pay", href: "/docs/integrations", desc: "Native OAuth + OUSD charges" },
      { label: "Pro Partner API", href: "/partner-api", desc: "Create apps · client ID · callbacks" },
        ...
        <div className="mx-auto grid max-w-295 gap-10 px-5 py-14 sm:px-8 md:grid-cols-4">
          ...
          <FooterCol
            ...
            links={[
              ...
              { label: "Pro Pay · Merchant", href: "/docs/pro-pay" },
              { label: "Pro Connect · Auth & Pay", href: "/docs/integrations" },
              { label: "Pro Partner API", href: "/partner-api" },
